...
describe Invoice do
  describe ".create!" do
    ...
    it "raises an error if the invoice is invalid" do
      client = Client.create!(name: "John")
      expect do
        described_class.create!(client:, amount: nil, title: "Truck repair",
                                description: "Repair of the truck")
      end.to raise_error(ArgumentError, "Amount is required, Amount must be greater than 5")

      expect do
        described_class.create!(client:, amount: 5, title: "Truck repair",
                                description: "Repair of the truck")
      end.to raise_error(ArgumentError, "Amount must be greater than 5")
    end
  end
